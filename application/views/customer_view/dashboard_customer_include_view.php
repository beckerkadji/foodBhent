...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item <?php if($name === 'customer_content_view'):?>active<?php endif; ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url()?>customer/listcommandepending">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2">avec un compte premium chez <strong>food manage</strong> le temps de livraison de vos commandes est plus court</p>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php 
            if($name == 'customer_content_view')
            {
                include('customer_content_view.php');
            }
